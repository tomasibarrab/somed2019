;;window.Resources = {
  "app.title": "Marketing",
  "app.errorTitle": "Essayons de nouveau",
  "app.errorMessage": "Veuillez recharger la page. Si le problème persiste, prière de contacter support@opentable.com. Il nous fera plaisir de vous aider.",
  "app.unpublished": "Vos modifications n'ont pas été publiées. Désirez-vous quitter sans publier?",
  "days.sunday.long": "dimanche",
  "days.monday.long": "lundi",
  "days.tuesday.long": "mardi",
  "days.wednesday.long": "mercredi",
  "days.thursday.long": "jeudi",
  "days.friday.long": "vendredi",
  "days.saturday.long": "samedi",
  "days.sunday.short": "dim",
  "days.monday.short": "lun",
  "days.tuesday.short": "mar",
  "days.wednesday.short": "mer",
  "days.thursday.short": "jeu",
  "days.friday.short": "ven",
  "days.saturday.short": "sam",
  "times.morning.name": "Matin",
  "times.midday.name": "Midi",
  "times.evening.name": "Soir",
  ...
  "flexiblepricing.educationpage.discoveryexplanation.content.criteria.reviews": "Commentaires",
  ...
  "flexiblepricing.summary.signup_for_this": "Signup for this program does not alter any Promoted Results, Bonus Points, or Custom Promotions campaigns you are currently running",
  ...
  "nav.custompromotions": "Promotions personnalisées",
  "nav.seasonal": "Promos saisonnières",
  "nav.featured": "Listes vedettes",
  "nav.flexiblepricing": "Flexible Pricing",
  "nav.insights": "Insights",
  "nav.privatedining": "Salles privées",
  "nav.guestcampaigns": "Campagne publicitaire",
  "nav.campaigns": "Campaigns",
  "nav.promotedresults": "Résultats en tête de liste",
  ...
  "seasonal.title": "Promotions saisonnières",
  "seasonal.subtitle": "C'est rentable de participer à des promotions saisonnières. Les clients sont deux fois plus susceptibles de se réserver des tables pour la période des fêtes. Assurez-vous de bien présenter vos menus spéciaux, vos aubaines, vos heures d'ouverture, vos événements et vos offres.",
  "seasonal.joined.subtitle": "Vos promotions",
  "seasonal.unjoined.subtitle": "Ajouter Promos",
  "featured.title": "Listes vedettes",
  "featured.subtitle": "Les gens ont tendance à visiter votre restaurant lorsque vous faites la promotion de vos menus spéciaux, des caractéristiques particulières de votre établissement et des menus qui tiennent compte de certaines restrictions alimentaires! Allez-y! Vantez-vous des menus que vous offrez pour le brunch ou encore de vos plats sans gluten.",
  "featured.joined.subtitle": "Vos listes",
  "featured.unjoined.subtitle": "Ajouter des listes",
  "leadgen.form.description": "Dites-nous comment entrer en contact avec vous et nous vous contacterons dans un délai de 48 heures.",
  "leadgen.form.description_24": "Dites-nous comment entrer en contact avec vous et nous vous contacterons dans un délai de 24 heures.",
  "leadgen.submitted.title": "Merci!",
  "leadgen.submitted.simpleMessage": "Un employé du restaurant vous contactera dans un délai de 48 heures.",
  "leadgen.submitted.simpleMessage_24": "A member of the restaurant team will reach out within 24 hours.",
  "leadgen.submitted.message": "Nous vous contacterons prochainement. Vous pouvez, entre temps, en apprendre davantage sur l'option Salles à manger privées {here}",
  "leadgen.here": "ici",
  "label.firstName": "Prénom",
  "label.lastName": "Nom de famille",
  "label.emailAddress": "Adresse e-mail",
  "label.phoneNumber": "Numéro de téléphone",
  "privatedining.title": "Salles privées",
  "gifts.title": "Gifts",
  "gifts.liveDate": "Le nouveau programme OpenTable Gifts sera mis en ligne le 1er octobre 2018, et sa version actuelle sera alors obsolète.  Inscrivez-vous sans plus attendre pour vous assurer qu'il n'y ait pas d'interruption dans vos ventes de cartes-cadeaux.",
  "gifts.landing.one.header": "Touchez davantage de convives",
  "gifts.landing.one": "Proposez vos cartes-cadeaux aux 5 millions de convives qui cherchent à faire profiter d'autres personnes de leurs restaurants favoris.",
  "gifts.landing.two.header": "Augmentez vos profits",
  "gifts.landing.two": "Touchez ces convives pour 25 $/mois. Il vous suffit de disposer d'une page Web pour vendre vos cartes-cadeaux.",
  "gifts.landing.cta": "Inscrivez-vous",
  "gifts.main.gift_card_website.title": "Site Web dédié aux cartes-cadeaux",
  "gifts.main.gift_card_website.description": "Si vous disposez de plusieurs sites Web pour les achats de cartes virtuelles et physiques, entrez l'adresse d'un site sur lequel les convives peuvent sélectionner l'une ou l'autre de ces options.",
  "gifts.main.header.cancel": "Annuler",
  "gifts.main.header.publish": "Publier",
  "gifts.main.header.save": "Enregistrer",
  "gifts.main.toast.success": "Success! Your Gift Card website link has been updated.",
  "gifts.terms.client_has_read": "Le client a lu et compris les modalités du {gifts-client-agreement-link}, et accepte de s'y soumettre. Par la présente, je déclare et je garantis avoir l'âge légal pour conclure un contrat obligatoire et avoir la pleine autorité légale pour lier le Client au présent Contrat.",
  "gifts.terms.sign_up": "Inscrivez-vous",
  "gifts.terms.must_be_authorized": "Vous devez être autorisé à signer au nom de votre restaurant",
  "gifts.terms.gifts_client_agreement": "Contrat client Gifts",
  "gifts.terms.description": "Afin vous inscrire au programme Gifts, vous devrez accepter le {gifts-client-agreement-link} et le versement de 25 $ par mois au nom de votre restaurant.",
  "gifts.finished.title": "Vous avez terminé!",
  "gifts.finished.description.1": "N'oubliez pas que le programme Gifts ne sera pas lancé avant le 1er octobre 2018.",
  "gifts.finished.description.2": "Avez-vous des questions? Consultez {our-faq-link} ou envoyez un e-mail à {gifts-email}.",
  "gifts.finished.description.1.heres": "Voici",
  "gifts.finished.description.2.our_faq": "notre FAQ",
  "gifts.finished.ok_got_it": "Parfait, c'est compris",
  "privatedining.leadgen.heading": "Permettez au public général de réserver votre salle à manger privée",
  "privatedining.leadgen.body": "Attirez plus de clients potentiels à des événements de groupes et des fêtes toute l'année. Lorsque votre espace est affiché sur nos listes de salles à manger privées, vous augmentez votre visibilité auprès de notre réseau et de notre clientèle qui reçoit cette liste par e-mail. De plus, votre salle obtiendra un meilleur rang dans les résultats du moteur de recherche Google.",
  "privatedining.leadgen.button.label": "Je suis intéressé",
  "privatedining.enabled.heading": "Vous vous êtes inscrits à la liste de salles à manger privées",
  "privatedining.enabled.body": "Nous vous invitons à communiquer avec notre équipe de soutien à la clientèle pour apporter des modification à votre profil:",
  "privatedining.enabled.body.email": "support@opentable.com",
  ...
  "privatedining.enabled.body.email.thankyou": "Merci!",
  "privatedining.enabled.body.phone": "ou contactez-nous à l'adresse support@opentable.com.",
  "privatedining.form.publish": "Publier",
  "privatedining.form.publish.success": "Merci! Nous avons bien reçu votre profil. Nous vous informerons dès qu'il sera en direct, dans un délai de 48 heures.",
  "privatedining.form.publish.error.modal.title": "Salles privées",
  "privatedining.form.publish.error.modal.message": "Votre profil pour les salles à manger privées n'a pas pu être publié. Veuillez essayer de nouveau.",
  "privatedining.form.publish.error.modal.ok": "OK",
  "privatedining.enabled.v2.section.info.title": "Détails pour les salles privées",
  "privatedining.enabled.v2.section.info.listing.description": "Voici ce qui s'affichera sur votre page restaurants opentable.com et votre profil pour les salles à manger privées.",
  "privatedining.enabled.v2.section.contact.title": "Informations détaillées sur le coordonnateur d'événements",
  "privatedining.enabled.v2.section.contact.description": "Envoyez des informations détaillées à votre clientèle sur la personne à contacter pour obtenir plus d'informations sur les salles à manger privées.",
  "privatedining.enabled.v2.section.rooms.title": "Choix de salles à manger privées",
  "privatedining.enabled.v2.section.rooms.description": "Listez jusqu'à cinq salles à manger privées que vous désirez promouvoir sur votre profil.",
  "privatedining.enabled.v2.fields.name": "Nom",
  "privatedining.enabled.v2.fields.phone": "Numéro de téléphone",
  "privatedining.enabled.v2.fields.phone.ext": "Poste",
  "privatedining.enabled.v2.fields.email": "Adresse e-mail",
  "privatedining.enabled.v2.fields.listing.description": "Courte description",
  "privatedining.enabled.v2.fields.profile.description": "Description détaillée",
  "privatedining.enabled.v2.fields.url": "Exemple de menu URL",
  "privatedining.enabled.v2.fields.capacity": "Capacité maximale de la salle",
  "privatedining.enabled.v2.fields.photo": "Photo d'un repas dans une salle à manger privée",
  "privatedining.enabled.v2.fields.room.active": "Afficher la salle sur le profil",
  "privatedining.enabled.v2.fields.room.name": "Nom de la salle",
  "privatedining.enabled.v2.fields.room.description": "Description",
  "privatedining.enabled.v2.fields.room.seated": "Nombre maximal de places assises",
  "privatedining.enabled.v2.fields.room.standing": "Nombre de places debout",
  "privatedining.enabled.v2.fields.room.photo": "Photo d'un repas dans une salle à manger privée",
  "privatedining.enabled.v2.fields.room.add": "+ Ajouter une autre pièce",
  "privatedining.enabled.v2.photo.modal.add.title": "Ajouter une photo",
  "privatedining.enabled.v2.photo.modal.crop.title": "Recadrer photo",
  "privatedining.enabled.v2.photo.modal.instructions": "Faites glisser et déposez votre photo ou",
  "privatedining.enabled.v2.photo.modal.select": "Sélectionnez photo",
  "privatedining.enabled.v2.photo.modal.standards": "Utilisez JPEG ou PNG, 512 x 512 pixels min, 10 Mo max.",
  "privatedining.enabled.v2.photo.modal.errors.toosmall": "La photo est trop petite. La taille minimale doit être de 512 x 512 pixels.",
  "privatedining.enabled.v2.photo.modal.errors.wrongtype": "Nous ne reconnaissons pas ce format de fichier. Prière de télécharger un fichier JPEG ou PNG.",
  "privatedining.enabled.v2.photo.add": "+ Ajouter une photo",
  "privatedining.enabled.v2.photo.replace": "Remplacer photo",
  "privatedining.enabled.v2.photo.save": "Enregistrer",
  "guestcampaigns.title": "Résultats en tête de liste",
  "guestcampaigns.support.phone": "(800) 673-6822",
  "guestcampaigns.heading": "Attirez des clients avec les résultats promus",
  "guestcampaigns.subheading": "Apparaissez en vedette dans les résultats de la recherche pour augmenter votre visibilité auprès des clients indécis.",
  "guestcampaigns.beincontrol.title": "Be in control",
  "guestcampaigns.targetdiners.title": "Ciblez les clients de votre choix",
  ...
  "guestcampaigns.targetdiners.description": "Choisissez entre les clients de dernière minute ou les nouveaux clients. Ou ciblez ces deux catégories !",
  "guestcampaigns.promotedinventory.description": "Propulsez votre restaurant en haut de la liste des résultats de recherche.",
  ...
  "guestcampaigns.list.campaigndates": "Jours et heures",
  "guestcampaigns.list.campaigndetails": "Campaign Details",
  "guestcampaigns.list.custom_promotion": "Custom Promotion",
  "guestcampaigns.list.custom_promotions": "Promotions personnalisées",
  "guestcampaigns.list.short_term_custom_promotions": "Promotions personnalisées à court terme",
  "guestcampaigns.list.start_date": "Start Date",
  "guestcampaigns.list.end_date": "End Date",
  "guestcampaigns.list.blockeddates": "Dates bloquées",
  "guestcampaigns.list.promoted_results": "Résultats en tête de liste",
  ...
  "guestcampaigns.list.specials": "Offres spéciales",
  ...
  "guestcampaigns.specials.form.header.cancelbutton": "Annuler",
  "guestcampaigns.specials.form.header.publishbutton": "Publier",
  "guestcampaigns.specials.form.header.title": "Créer une nouvelle offre spéciale",
  ...
  "guestcampaigns.specials.form.type.title": "Type d'offre",
  "guestcampaigns.specials.form.type.description": "Choisissez le type d'offre spéciale à proposer.",
  "guestcampaigns.specials.form.type.happy_hour": "Happy Hour",
  "guestcampaigns.specials.form.type.complimentary_drink": "Boisson gratuite",
  "guestcampaigns.specials.form.type.complimentary_appetizer": "Entrée gratuite",
  "guestcampaigns.specials.form.alcohol_warning": "Special offers on alcoholic beverages may be restricted by state law.",
  "guestcampaigns.specials.form.title.title": "Titre",
  "guestcampaigns.specials.form.title.description": "Modifiez ce titre pour le rendre unique. Les convives le verront sur OpenTable.",
  ...
  "guestcampaigns.specials.form.title.tips.1": "Plus que la description, c'est cela qui attire les clients.",
  "guestcampaigns.specials.form.title.tips.2": "Donnez du caractère à votre titre.",
  "guestcampaigns.specials.form.title.tips.3": "Utilisez un maximum de 5 mots (inutile d'inclure le nom du restaurant).",
  "guestcampaigns.specials.form.description.title": "Description",
  "guestcampaigns.specials.form.description.description": "Rendez cette description unique. Les clients la verront sur votre profil de restaurant OpenTable.",
  ...
  "guestcampaigns.specials.form.description.tips.1": "Décrivez votre offre.",
  "guestcampaigns.specials.form.description.tips.2": "Limitez-vous à un maximum de 2 phrases.",
  "guestcampaigns.specials.form.description.tips.3": "Remarque : si vous faites la promotion d'une offre spéciale à un prix donné, n'oubliez pas d'inclure les taxes et le service.",
  "guestcampaigns.specials.form.startdate.title": "Date de début des réservations",
  "guestcampaigns.specials.form.startdate.description": "Nous avons présélectionné une date dans une semaine à compter d'aujourd'hui. Les clients ont ainsi le temps de réserver votre offre spéciale.",
  ...
  "guestcampaigns.specials.form.daysandtimes.title": "Jours et heures",
  "guestcampaigns.specials.form.daysandtimes.description": "Indiquez les jours et heures auxquels vous souhaitez proposer votre offre spéciale.",
  "guestcampaigns.specials.form.daysandtimes.tips.1": "Nous vous recommandons de sélectionner des heures durant lesquelles vous avez déjà un happy hour ou une offre spéciale.",
  "guestcampaigns.specials.form.daysandtimes.tips.2.happy_hour": "Do you run happy hour at multiple times?",
  "guestcampaigns.specials.form.daysandtimes.tips.2.generic": "Souhaitez-vous proposer cette offre spéciale à plusieurs reprises ?",
  "guestcampaigns.specials.form.daysandtimes.tips.2.add": "Ajoutez un autre créneau (date et heure).",
  "guestcampaigns.specials.form.blockeddays.title": "Jours bloqués",
  "guestcampaigns.specials.form.blockeddays.description": "Indiquez les jours durant lesquels vous ne souhaitez pas proposer d'offres spéciales. Par défaut, nous bloquons les jours qui attirent généralement le plus de clients.",
  "guestcampaigns.specials.form.blockeddays.add": "Ajouter des jours bloqués",
  "guestcampaigns.specials.form.nextstep.title": "Étape suivante",
  "guestcampaigns.specials.form.nextstep.description.1": "Publiez votre offre spéciale",
  "guestcampaigns.specials.form.nextstep.description.2": "sans frais supplémentaires.",
  "guestcampaigns.specials.landingpage.standout.title": "Attirez davantage de convives au moment opportun.",
  "guestcampaigns.specials.landingpage.standout.subtitle": "Les offres spéciales incluent une offre de votre choix. C'est la façon idéale pour :",
  "guestcampaigns.specials.landingpage.bullet.1.title": "Élargir votre portée.",
  "guestcampaigns.specials.landingpage.bullet.1.description": "Lorsque vous proposez une offre spéciale, votre nombre moyen de couverts augmente de 5 %.",
  "guestcampaigns.specials.landingpage.bullet.2.title": "Maximiser votre rendement.",
  "guestcampaigns.specials.landingpage.bullet.2.description": "Les tables non occupées constituent une perte. Proposer une offre spéciale, aussi petite soit-elle, est susceptible d'attirer des convives.",
  "guestcampaigns.specials.landingpage.bullet.3.title": "Rentabiliser les périodes de travail lentes.",
  "guestcampaigns.specials.landingpage.bullet.3.description": "Attirez davantage de convives durant la période hors-saison, les nuits calmes ou à tout autre moment.",
  "guestcampaigns.specials.landingpage.free": "Les offres spéciales sont gratuites (elles sont incluses dans vos frais de couvert).",
  "guestcampaigns.specials.landingpage.create": "Créer une offre spéciale",
  "guestcampaigns.specials.completed.heading": "Vous avez terminé ! Votre offre spéciale sera publiée dans les 30 prochaines minutes.",
  "guestcampaigns.specials.completed.description.confirmationemail": "Nous vous enverrons un e-mail de confirmation.",
  "guestcampaigns.specials.completed.description.questions": "Entre-temps, si vous avez des questions sur les offres spéciales, veuillez contacter support@opentable.com",
  "guestcampaigns.terms.terms_and_conditions": "Conditions générales",
  "guestcampaigns.terms.specials.description": "Pour publier cette offre spéciale, vous devrez accepter les présentes conditions générales en renseignant votre nom, la dénomination sociale de votre restaurant et en confirmant avoir lu et accepté lesdites conditions.",
  ...
  "guestcampaigns.terms.your_email": "Votre adresse électronique",
  "guestcampaigns.terms.your_name": "Votre nom",
  "guestcampaigns.terms.authorized": "You must be authorized to sign for your restaurant",
  "guestcampaigns.terms.restaurant_legal_name": "Dénomination sociale de votre restaurant",
  "guestcampaigns.terms.client_has_read": "Le client a lu et compris les modalités de {opentable-client-agreement-link}, et accepte de s'y soumettre. Par la présente, je déclare et je garantis avoir l'âge légal pour conclure un contrat obligatoire et avoir la pleine autorité légale pour lier le Client au présent Contrat.",
  ...
  "guestcampaigns.terms.agree_and_publish": "Accepter et publier",
  ...
  "guestcampaigns.list.short_term_promoted_results": "Résultats en tête de liste à court terme",
  ...
  "guestcampaigns.list.resumesin": "Reprend le {in-time-amount}",
  "guestcampaigns.list.resumesat": "Reprend à",
  ...
  "guestcampaigns.list.noenddate": "Aucune date de fin",
  "guestcampaigns.list.bookingwindow": "Période de réservation",
  "guestcampaigns.list.seatingwindow": "Période d'attablement",
  "guestcampaigns.list.search_exposure": "Search Exposure",
  "guestcampaigns.list.cover_price": "Cover Price",
  "guestcampaigns.list.price": "Prix",
  "guestcampaigns.list.monthly_budget": "Monthly Budget",
  "guestcampaigns.list.days_and_times": "Jours et heures",
  ...
  "guestcampaigns.list.approver": "Approbateur",
  ...
  "guestcampaigns.list.custom_promotions.state_description_active": "Il s'agit de promotions personnalisées que vous proposez actuellement sur OpenTable.",
  "guestcampaigns.list.custom_promotions.state_description_inactive": "Il s'agit des promotions personnalisées que vous avez proposées par le passé.",
  ...
  "guestcampaigns.list.state_description_active": "Ces campagnes publicitaires sont actives sur le site web OpenTable et vous permettent d'accueillir plus de clients dans votre restaurant.",
  "guestcampaigns.list.state_description_inactive": "Ce sont des campagnes publicitaires que vous avez menées dans le passé. Elles ne sont plus actives et ne contribuent pas à l'achalandage de votre restaurant.",
  "guestcampaigns.list.state_description_paused": "Lorsque les campagnes sont arrêtées temporairement, elles ne produisent aucun résultat pour votre restaurant. Par contre, elles contribueront à l'achalandage de votre restaurant dès qu'elles seront relancées à l'heure indiquée. Nous vous invitons à communiquer avec votre représentant OpenTable au {phone-number} si vous avez des questions ou si vous désirez mettre fin à ces campagnes.",
  ...
  "guestcampaigns.list.incentive.title": "TITRE",
  "guestcampaigns.list.incentive.description": "Description",
  "guestcampaigns.list.incentive.terms": "Conditions générales",
  ...
  "guestcampaigns.list.incentive.approver": "Approbateur",
  ...
  "guestcampaigns.list.edit_blocked_days": "Modifiez les jours bloqués",
  ...
  "guestcampaigns.list.button.got_it": "Parfait, c'est compris",
  ...
  "guestcampaigns.list.blockdays.button.days": "Jours bloqués",
  ...
  "guestcampaigns.list.blockdays.confirm.button.cancel": "Annuler",
  ...
  "guestcampaigns.custompromotions.landingpage.line_3": "Our new Custom Promotions program can help drive more guests starting at $2.75/cover.",
  "guestcampaigns.custompromotions.landingpage.cta_button": "Learn More",
  "promos.flash.published": "Votre offre promotionnelle a été publiée.",
  "promos.flash.saved": "Votre offre promotionnelle a été sauvegardée.",
  "promos.flash.removed": "Votre offre promotionnelle a été supprimée.",
  "promos.card.view": "Consulter promo",
  "promos.card.edit": "Modifier",
  "promos.card.join": "Inscrivez-vous",
  "promos.card.liveNow": "EN DIRECT",
  "promos.card.count": "Restaurants de {count}",
  "promos.card.unavailable": "Les inscriptions seront ouvertes très bientôt pour l'année {year}",
  "promos.promo.name.1": "Action de grâces",
  "promos.promo.placeholder.1": "Offrez-vous un menu spécial pour l'Action de grâces? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.4": "Veille du jour de l'An",
  "promos.promo.placeholder.4": "Offrez-vous un menu spécial pour la Veille du Nouvel An? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.5": "Réveillon de Noël",
  "promos.promo.placeholder.5": "Offrez-vous un menu spécial pour Noël? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.6": "Jour de Noël",
  "promos.promo.placeholder.6": "Offrez-vous un menu spécial pour Noël? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.14": "En plein air",
  "promos.promo.description.14": "Lorsque la température est clémente—ou non, mais que vous avez des lampes chauffantes!—vos espaces extérieurs tels que votre balcon ou votre terrasse sont convoités.",
  "promos.promo.placeholder.14": "Dites-nous pourquoi vos terrasses attirent les clients.",
  "promos.promo.name.77": "Fête des Mères",
  "promos.promo.placeholder.77": "Offrez-vous un menu spécial pour la fête des Mères? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.85": "Fête des Pères",
  "promos.promo.placeholder.85": "Offrez-vous un menu spécial pour la fête des Pères? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.102": "Saint-Valentin",
  "promos.promo.placeholder.102": "Offrez-vous un menu spécial pour la Saint-Valentin Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.212": "Brunch",
  "promos.promo.description.212": "Des œufs, des crêpes, du hachis de confit de canard, pour ne nommer que quelques choix—Vos invités seront ravis de passer leur matinée à votre restaurant toutes les fins de semaine.",
  "promos.promo.placeholder.212": "Dites-nous pourquoi votre Brunch est le meilleur.",
  "promos.promo.name.228": "Pâques",
  "promos.promo.placeholder.228": "Offrez-vous un menu spécial pour Pâques? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.243": "Sortie théâtre",
  "promos.promo.description.243": "Votre service rapide et votre proximité aux centres culturels font de votre restaurant l'endroit idéal à visiter avant ou après le théâtre. Les clients à la recherche d'un endroit pour casser la croûte, quel que soit l'événement qui les amènent dans votre quartier, y trouveront aussi leur compte.",
  "promos.promo.placeholder.243": "Dites-nous pourquoi votre restaurant est un excellent choix pour les amateurs de théâtre.",
  "promos.promo.name.355": "Cinco de Mayo",
  "promos.promo.placeholder.355": "Votre restaurant fait-il quelque chose de spécial pour Cinco de Mayo? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette année.",
  "promos.promo.name.369": "L'univers du cocktail",
  "promos.promo.description.369": "Avec sa sélection de cocktails artisanaux, ses cinq à sept dynamiques et sa liste de vins variés, votre restaurant place la barre haute pour ceux qui aiment prendre un verre.",
  "promos.promo.placeholder.369": "Dites-nous pourquoi les amateurs de cocktails artisanaux se précipiteront vers votre bar.",
  "promos.promo.name.370": "AVV",
  "promos.promo.description.370": "Prenez-vous un droit de bouchon? Avez-vous un permis d'alcool? Diffusez la bonne nouvelle! Vos invités peuvent désormais apporter leur vin pour le siroter dans votre restaurant.",
  "promos.promo.placeholder.370": "Dites-nous comment votre nouveau statut de restaurant AVV rehaussera l'expérience gastronomique.",
  "promos.promo.name.371": "Repas pour les décideurs",
  "promos.promo.description.371": "Lorsque votre restaurant est situé dans un quartier commercial, que vous servez surtout des repas à des hommes d'affaires et que vous divertissez régulièrement des groupes de travail, on peut considérer que c'est votre spécialité.",
  "promos.promo.placeholder.371": "Dites-nous pourquoi vous attirez une clientèle formée de gens d'affaires.",
  "promos.promo.name.630": "Sans gluten ",
  "promos.promo.description.630": "Offrez-vous des pâtes sans gluten ou encore des grains de rechange? Si votre menu contient un certain nombre de plats conçus précisément pour les régimes alimentaires sans blé ni gluten, nous vous invitons à le faire savoir à vos clients.",
  "promos.promo.placeholder.630": "Dites-nous pourquoi votre menu sans gluten est unique en ville.",
  "promos.promo.name.631": "Bon pour les végétariens",
  "promos.promo.description.631": "Offrez-vous un menu qui contient certains plats qui peuvent satisfaire l'appétit d'un végétarien ou végétalien gourmand?",
  "promos.promo.placeholder.631": "Dites-nous comment votre menu à base de plantes peut satisfaire les invités qui ne mangent pas de viande.",
  "promos.promo.name.728": "Hanukkah",
  "promos.promo.placeholder.728": "Offrez-vous un menu spécial pour Hanukkah? Dites-nous pourquoi votre restaurant est l'endroit idéal pour célébrer cette fête.",
  "promos.form.title.join": "Apporter des précisions à l'offre promotionnelle {promoName}",
  "promos.form.title.edit": "Modifier les détails de la promotion {promoName}",
  "promos.form.description": "Ce que vos clients doivent savoir",
  "promos.form.placeholder": "Dites-nous pourquoi votre restaurant est l'endroit idéal pour réserver une table dans le cadre de cette offre promotionnelle.",
  "promos.form.enableCreditCard": "Nous vous prions d'activer Stripe à partir de GuestCenter au lien suivant {restaurantSettingsLink}, pour configurer les retenues sur les cartes de crédit pour les offres promotionnelles.",
  "promos.form.restaurantSettings": "Paramètres de configuration du restaurant",
  "promos.form.requireCreditCard": "Demandez un numéro de carte de crédit en guise de garantie",
  "promos.form.timeRangeStart": "Début",
  "promos.form.timeRangeEnd": "Fin",
  "promos.form.timeRangeDivider": "à",
  "promos.form.betweenTimes": "entre les heures",
  "promos.form.duringAllShifts": "pendant tous les services",
  "promos.form.timeRangeInvalidMessage": "Veuillez entrer une heure de fin qui se situe après l'heure de début",
  "promos.form.inform": "Avisez les clients que des frais d'annulation pourraient s'appliquer",
  "promos.form.amount": "Frais de () par personne",
  "promos.form.days": "Si les réservations sont annulées",
  "promos.form.dayBefore": "Une journée avant",
  "promos.form.daysBefore": "{days} jours avant",
  "promos.form.dayOf": "Le jour même",
  "promos.form.publish": "Publier",
  "promos.form.save": "Enregistrer",
  "promos.form.leave": "Supprimer ce restaurant pour cette offre promo",
  "promos.form.leave.confirm": "Confirmer la suppression du restaurant?",
  "promos.form.error": "Votre promotion n'a pas pu être publiée. Veuillez essayer de nouveau"
}