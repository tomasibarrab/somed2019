;;window.Resources = {
  ...
  "gifts.title": "Gifts",
  "gifts.liveDate": "The new OpenTable Gifts goes live October 1st, 2018 and the current version of OpenTable Gifts will be deprecated.  Sign-up for the new program today to ensure there is no disruption in your gift card sales!",
  "gifts.landing.one.header": "Reach more guests",
  "gifts.landing.one": "Market your gift cards to 5 million guests who are looking to give others their favorite dining experiences.",
  ...
  "gifts.terms.must_be_authorized": "You must be authorized to sign for your restaurant",
  ...
  "gifts.finished.description.1": "Remember, Gifts won’t be launched until Oct 1, 2018.",
  ...
  "privatedining.enabled.body.phone": "or call us at 1-800-OPENTABLE.",
  ...
  "privatedining.enabled.v2.photo.modal.errors.wrongtype": "We don't recognize that file format. Please upload a JPEG or PNG file.",
  ...
  "guestcampaigns.specials.form.type.complimentary_appetizer": "Complimentary Appetizer",
  ...
  "guestcampaigns.specials.landingpage.bullet.2.title": "Maximize your return.",
  ...
  "guestcampaigns.specials.completed.description.questions": "In the meantime, if you have questions about specials, call support at 1-800-OPENTABLE",
  ...
  "promos.form.enableCreditCard": "To set up credit card holds for promotions enable Stripe in Guest Center under {restaurantSettingsLink}",
