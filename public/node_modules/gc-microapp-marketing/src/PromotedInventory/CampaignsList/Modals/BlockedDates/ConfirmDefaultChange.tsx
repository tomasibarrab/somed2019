...
const ConfirmDefaultChange: SFC<ConfirmProps & InjectedIntlProps> = ({
  ...
  const label = defaultSuppressionDates.find((defaultDate: DefaultSuppressionDateDescription) => defaultDate.id === id)
    .label;
  return (
