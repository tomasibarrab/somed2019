;;window.Resources = {
  "app.title": "マーケティング",
  "app.errorTitle": "再度お試しください",
  "app.errorMessage": "ページをリロードしてください。問題が解決しない場合は、OpenTable カスタマーサポート（050-2018-7377）までご連絡ください。",
  "app.unpublished": "未反映の変更があります。このままページを離れますか？",
  "days.sunday.long": "日",
  "days.monday.long": "月曜日",
  "days.tuesday.long": "火曜日",
  "days.wednesday.long": "水曜日",
  "days.thursday.long": "木曜日",
  "days.friday.long": "（金）",
  "days.saturday.long": "土曜日",
  "days.sunday.short": "日",
  "days.monday.short": "月",
  "days.tuesday.short": "火",
  "days.wednesday.short": "水",
  "days.thursday.short": "木",
  "days.friday.short": "金",
  "days.saturday.short": "土",
  "times.morning.name": "朝",
  "times.midday.name": "昼間",
  "times.evening.name": "夜",
  "times.morning.period": "開店～午前10時",
  "times.midday.period": "午前10時～午後4時",
  "times.evening.period": "午後4時～閉店",
  ...
  "flexiblepricing.educationpage.discoveryexplanation.content.criteria.reviews": "評価・口コミ",
  ...
  "nav.custompromotions": "カスタムプロモーション",
  "nav.seasonal": "季節のプロモーション",
  "nav.featured": "特集リスト",
  "nav.flexiblepricing": "Flexible Pricing",
  "nav.insights": "Insights",
  "nav.privatedining": "パーティー・貸切",
  "nav.guestcampaigns": "キャンペーン",
  "nav.campaigns": "Campaigns",
  "nav.promotedresults": "検索プロモーション",
  "nav.specials": "スペシャルプラン",
  "nav.gifts": "Gifts",
  ...
  "seasonal.title": "季節のプロモーション",
  "seasonal.subtitle": "季節のプロモーションに参加することで、収益アップにつなげることができます。祝祭日には通常の2倍のご予約件数が期待できるため、特別メニューやセットメニュー、提供時間、イベント、プランをもれなくアピールしましょう。",
  "seasonal.joined.subtitle": "追加済みのプロモーション",
  "seasonal.unjoined.subtitle": "プロモーションを追加する",
  "featured.title": "特集リスト",
  "featured.subtitle": "スペシャルメニュー、お店の特長、お食事制限への対応、特集プランなどをプロモーションすることで、お客様に貴店を選んでいただきやすくなります。ブランチメニューやグルテンフリー料理など、お店の売りを前面に押し出しましょう。",
  "featured.joined.subtitle": "貴店の特集",
  "featured.unjoined.subtitle": "リストを追加する",
  "leadgen.form.description": "連絡先を入力してください。48時間以内にご連絡を差し上げます。",
  "leadgen.form.description_24": "連絡方法を指定してください。24時間以内にご連絡します。",
  "leadgen.submitted.title": "ありがとうございます！",
  "leadgen.submitted.simpleMessage": "レストランチームの担当者より48時間以内にご連絡を差し上げます。",
  "leadgen.submitted.simpleMessage_24": "A member of the restaurant team will reach out within 24 hours.",
  "leadgen.submitted.message": "担当者よりご連絡を差し上げます。パーティー・貸切についての詳細情報は、{here}をご覧ください。",
  "leadgen.here": "こちら",
  "label.firstName": "お名前（名）",
  "label.lastName": "お名前（姓）",
  "label.emailAddress": "メールアドレス",
  "label.phoneNumber": "電話番号",
  "privatedining.title": "パーティー・貸切",
  "gifts.title": "Gifts",
  "gifts.liveDate": "新しい OpenTable Gifts は2018年10月1日から公開されます。旧バージョンの OpenTable Gifts はご利用いただけなくなりますのでご注意ください。新しいプログラムに登録して、貴店のギフトカードを滞りなく販売できるようにしましょう。",
  "gifts.landing.one.header": "集客アップ",
  "gifts.landing.one": "貴店のギフトカードを500万人に宣伝して、貴店の良さを拡散することができます。",
  "gifts.landing.two.header": "利益拡大",
  "gifts.landing.two": "月々25ドルでより多くのお客様を獲得しましょう。必要なのはギフトカードを販売するウェブページのみ。",
  "gifts.landing.cta": "申し込む",
  "gifts.main.gift_card_website.title": "ギフトカードのウェブサイト",
  "gifts.main.gift_card_website.description": "購入の際にギフトカードと、電子ギフトカードで異なるウェブサイトをお持ちの場合は、購入オプションの選択ができるURLを入力してください。",
  "gifts.main.header.cancel": "キャンセル",
  "gifts.main.header.publish": "設定更新",
  "gifts.main.header.save": "保存",
  "gifts.main.toast.success": "Success! Your Gift Card website link has been updated.",
  "gifts.terms.client_has_read": "クライアントは、{gifts-client-agreement-link}の内容を確認および理解し、これによって拘束される旨に同意します。私は拘束力のある契約を締結できる法的年齢に達しており、クライアントを本同意に拘束する法的権限を有することを、ここに表明し保証します。",
  "gifts.terms.sign_up": "登録する",
  "gifts.terms.must_be_authorized": "店舗を代表して契約締結権限を持つ方のお名前を記入してください。",
  "gifts.terms.gifts_client_agreement": "OpenTable Gifts に関するクライアント契約",
  "gifts.terms.description": "OpenTable Gifts に登録するには、貴店を代表して、{gifts-client-agreement-link}および月々25ドルを支払う旨に同意する必要があります。",
  "gifts.finished.title": "You’re done!",
  "gifts.finished.description.1": "OpenTable Gifts は2018年10月1日からご利用になれます。",
  ...
  "gifts.finished.description.2.our_faq": "よくある質問",
  "gifts.finished.ok_got_it": "OK",
  "privatedining.leadgen.heading": "パーティー・貸切用の個室を紹介しましょう",
  "privatedining.leadgen.body": "イベントやパーティーなど、さまざまな年間イベントに合わせて、より多くの有望な見込み客を獲得しましょう。「パーティー・貸切」では、OpenTable のネットワーク、Google検索、お客様へのメールで貴店をリスト表示し、貴店の露出度を高めます。",
  "privatedining.leadgen.button.label": "試してみる",
  "privatedining.enabled.heading": "「パーティー・貸切」に登録しました",
  ...
  "privatedining.enabled.body.email.thankyou": "よろしくお願いいたします。",
  "privatedining.enabled.body.phone": "または、OpenTable カスタマーサポート（050-2018-7377）までご連絡ください。",
  "privatedining.form.publish": "設定更新",
  "privatedining.form.publish.success": "プロフィールを受信しました。公開され次第お知らせいたします。最大で48時間かかります。",
  "privatedining.form.publish.error.modal.title": "パーティー・貸切",
  "privatedining.form.publish.error.modal.message": "「パーティー・貸切」のプロフィールを公開できませんでした。再度お試しください。",
  "privatedining.form.publish.error.modal.ok": "OK",
  "privatedining.enabled.v2.section.info.title": "パーティー・貸切の詳細",
  "privatedining.enabled.v2.section.info.listing.description": "これは貴店の OpenTable のプロフィールページと「パーティー・貸切」のプロフィールに表示されます。",
  "privatedining.enabled.v2.section.contact.title": "イベントコーディネーターの詳細",
  "privatedining.enabled.v2.section.contact.description": "パーティー・貸切についての問い合わせ先を記載してください。",
  "privatedining.enabled.v2.section.rooms.title": "パーティー・貸切のオプション",
  "privatedining.enabled.v2.section.rooms.description": "最大で5つのパーティー・貸切用エリアを、貴店の「パーティー・貸切」のプロフィールに掲載できます。",
  "privatedining.enabled.v2.fields.name": "名前",
  "privatedining.enabled.v2.fields.phone": "電話番号",
  "privatedining.enabled.v2.fields.phone.ext": "内線番号",
  "privatedining.enabled.v2.fields.email": "メールアドレス",
  "privatedining.enabled.v2.fields.listing.description": "概要",
  "privatedining.enabled.v2.fields.profile.description": "詳細情報",
  "privatedining.enabled.v2.fields.url": "サンプルメニューのURL",
  "privatedining.enabled.v2.fields.capacity": "イベントの最大参加人数",
  "privatedining.enabled.v2.fields.photo": "パーティー・貸切の写真",
  "privatedining.enabled.v2.fields.room.active": "プロフィールに個室を表示する",
  "privatedining.enabled.v2.fields.room.name": "部屋の名称",
  "privatedining.enabled.v2.fields.room.description": "詳細情報",
  "privatedining.enabled.v2.fields.room.seated": "着席での収容人数",
  "privatedining.enabled.v2.fields.room.standing": "立食での収容人数",
  "privatedining.enabled.v2.fields.room.photo": "パーティー・貸切の写真",
  "privatedining.enabled.v2.fields.room.add": "+ 部屋を追加する",
  "privatedining.enabled.v2.photo.modal.add.title": "写真を追加する",
  "privatedining.enabled.v2.photo.modal.crop.title": "写真のトリミング",
  "privatedining.enabled.v2.photo.modal.instructions": "写真をドラッグアンドドロップ、または",
  "privatedining.enabled.v2.photo.modal.select": "写真を選択する",
  "privatedining.enabled.v2.photo.modal.standards": "512x512ピクセル以上、10MB以下のJPEGファイルまたはPNGファイルを使用してください。",
  "privatedining.enabled.v2.photo.modal.errors.toosmall": "写真サイズが小さすぎます。512x512ピクセル以上の写真を使用してください。",
  "privatedining.enabled.v2.photo.modal.errors.wrongtype": "ファイル形式が正しくありません。JPEGファイルまたはPNGファイルをアップロードしてください。",
  "privatedining.enabled.v2.photo.add": "+ 写真を追加する",
  "privatedining.enabled.v2.photo.replace": "写真を変更する",
  "privatedining.enabled.v2.photo.save": "保存する",
  "guestcampaigns.title": "検索プロモーション",
  "guestcampaigns.support.phone": "(800) 673-6822",
  "guestcampaigns.heading": "検索プロモーションで集客アップ",
  "guestcampaigns.subheading": "検索結果の優先表示により、お店を検索中のお客様に効果的にアピールできます。",
  "guestcampaigns.beincontrol.title": "Be in control",
  "guestcampaigns.targetdiners.title": "ターゲットを絞った集客",
  ...
  "guestcampaigns.targetdiners.description": "直前にご予約するお客様、初来店のお客様など、ターゲットを絞って集客できます。",
  "guestcampaigns.promotedinventory.description": "貴店を検索結果の上位に表示します。",
  ...
  "guestcampaigns.list.type": "ご来店タイプ",
  ...
  "guestcampaigns.list.campaigndates": "曜日と時間",
  "guestcampaigns.list.campaigndetails": "Campaign Details",
  "guestcampaigns.list.custom_promotion": "Custom Promotion",
  "guestcampaigns.list.custom_promotions": "カスタムプロモーション",
  "guestcampaigns.list.short_term_custom_promotions": "カスタムプロモーション（短期）",
  "guestcampaigns.list.start_date": "Start Date",
  "guestcampaigns.list.end_date": "End Date",
  "guestcampaigns.list.blockeddates": "受付停止日",
  "guestcampaigns.list.promoted_results": "検索プロモーション",
  ...
  "guestcampaigns.list.specials": "スペシャルプラン",
  ...
  "guestcampaigns.specials.form.header.cancelbutton": "キャンセル",
  "guestcampaigns.specials.form.header.publishbutton": "公開",
  "guestcampaigns.specials.form.header.title": "スペシャルプランの新規作成",
  ...
  "guestcampaigns.specials.form.type.title": "タイプ",
  "guestcampaigns.specials.form.type.description": "実施するスペシャルプランを選択してください。",
  "guestcampaigns.specials.form.type.happy_hour": "ハッピーアワー",
  "guestcampaigns.specials.form.type.complimentary_drink": "飲み物の無料サービス",
  "guestcampaigns.specials.form.type.complimentary_appetizer": "前菜の無料サービス",
  "guestcampaigns.specials.form.alcohol_warning": "Special offers on alcoholic beverages may be restricted by state law.",
  "guestcampaigns.specials.form.title.title": "タイトル",
  "guestcampaigns.specials.form.title.description": "このタイトルは OpenTable 店舗ページでお客様に表示されます。貴店ならではのタイトルを付けてください。",
  ...
  "guestcampaigns.specials.form.title.tips.1": "タイトルはお客様を惹きつける決め手となります。",
  "guestcampaigns.specials.form.title.tips.2": "魅力的なタイトルにしてください。",
  "guestcampaigns.specials.form.title.tips.3": "70文字以下（タイトルに店舗名は不要）",
  "guestcampaigns.specials.form.description.title": "詳細情報",
  "guestcampaigns.specials.form.description.description": "この情報は OpenTable の店舗プロフィールに表示されます。貴店ならではの特長を盛り込んでください。",
  ...
  "guestcampaigns.specials.form.description.tips.1": "プランの内容を記載してください。",
  "guestcampaigns.specials.form.description.tips.2": "可能な限り、2行以下に収めてください。",
  "guestcampaigns.specials.form.description.tips.3": "スペシャルプランを特定の価格で提供する場合は、消費税とサービス料を含めた価格を記載してください。",
  "guestcampaigns.specials.form.startdate.title": "予約受付開始日",
  "guestcampaigns.specials.form.startdate.description": "お客様が貴店のスペシャルプランに予約を入れる準備期間として、本日から1週間後の日付が事前に設定されています。",
  ...
  "guestcampaigns.specials.form.daysandtimes.title": "曜日と時間",
  "guestcampaigns.specials.form.daysandtimes.description": "スペシャルプランを実施する曜日と時間を選択してください。",
  "guestcampaigns.specials.form.daysandtimes.tips.1": "過去にハッピーアワーやスペシャルプランを実施した経験のある時間を選択することを推奨します。",
  "guestcampaigns.specials.form.daysandtimes.tips.2.happy_hour": "Do you run happy hour at multiple times?",
  "guestcampaigns.specials.form.daysandtimes.tips.2.generic": "このスペシャルプランを複数回実施しますか？",
  "guestcampaigns.specials.form.daysandtimes.tips.2.add": "追加する曜日と時間を選択してください。",
  "guestcampaigns.specials.form.blockeddays.title": "ブロック日",
  "guestcampaigns.specials.form.blockeddays.description": "スペシャルプランを実施しない日付を設定してください。デフォルトでは、一般的に多くのお客様が来店する日がブロック日に設定されています。",
  "guestcampaigns.specials.form.blockeddays.add": "ブロック日を追加する",
  "guestcampaigns.specials.form.nextstep.title": "次のステップ",
  "guestcampaigns.specials.form.nextstep.description.1": "スペシャルプランを公開してください。",
  "guestcampaigns.specials.form.nextstep.description.2": "追加料金は発生しません。",
  "guestcampaigns.specials.landingpage.standout.title": "もっとお客様を獲得したいと思いませんか？",
  "guestcampaigns.specials.landingpage.standout.subtitle": "スペシャルプランの内容は自由に設定可能。実施すると次のようなメリットがあります。",
  "guestcampaigns.specials.landingpage.bullet.1.title": "より多くの顧客を惹きつける",
  "guestcampaigns.specials.landingpage.bullet.1.description": "スペシャルプランを実施すると、平均で5％の予約人数の増加を見込めます。",
  "guestcampaigns.specials.landingpage.bullet.2.title": "利益を最大化する",
  "guestcampaigns.specials.landingpage.bullet.2.description": "空席は利益損失に直結します。少しでも何か特別なプランを用意することで、より多くの顧客にアピールできます。",
  "guestcampaigns.specials.landingpage.bullet.3.title": "閑散期でも集客アップ",
  "guestcampaigns.specials.landingpage.bullet.3.description": "閑散期や客足が途絶える夜の時間帯などでも、より多くのダイナーを惹きつけることができます。",
  "guestcampaigns.specials.landingpage.free": "スペシャルプランは無料で実施できます。（費用はカバー料金に含まれています。）",
  "guestcampaigns.specials.landingpage.create": "スペシャルプランを作成する",
  "guestcampaigns.specials.completed.heading": "スペシャルプランの作成が完了しました。貴店のスペシャルプランは30分以内に公開されます。",
  "guestcampaigns.specials.completed.description.confirmationemail": "確認メールをお送りします。",
  "guestcampaigns.specials.completed.description.questions": "公開にあたり、スペシャルプランに関してご質問がありましたら、サポート（050-2018-7377）までお問合せください。",
  "guestcampaigns.terms.terms_and_conditions": "ご利用規約",
  "guestcampaigns.terms.specials.description": "スペシャルプランを公開するには、お名前と店舗の正式名称を記入し、ご利用規約を確認および承認した上で、ご利用規約に同意する必要があります。",
  ...
  "guestcampaigns.terms.your_email": "メールアドレス",
  "guestcampaigns.terms.your_name": "お名前",
  "guestcampaigns.terms.authorized": "You must be authorized to sign for your restaurant",
  "guestcampaigns.terms.restaurant_legal_name": "店舗の正式名称",
  "guestcampaigns.terms.client_has_read": "クライアントは、{opentable-client-agreement-link}の内容を確認および理解し、これによって拘束される旨に同意します。私は拘束力のある契約を締結できる法的年齢に達しており、クライアントを本同意に拘束する法的権限を有することを、ここに表明し保証します。",
  ...
  "guestcampaigns.terms.agree_and_publish": "上記の内容に同意の上、公開する",
  ...
  "guestcampaigns.list.short_term_promoted_results": "検索プロモーション（短期）",
  ...
  "guestcampaigns.list.resumesin": "{in-time-amount}で再開",
  "guestcampaigns.list.resumesat": "再開日時",
  ...
  "guestcampaigns.list.noenddate": "終了日なし",
  "guestcampaigns.list.bookingwindow": "予約期間",
  "guestcampaigns.list.seatingwindow": "提供期間",
  "guestcampaigns.list.search_exposure": "Search Exposure",
  "guestcampaigns.list.cover_price": "Cover Price",
  "guestcampaigns.list.price": "料金",
  "guestcampaigns.list.monthly_budget": "Monthly Budget",
  "guestcampaigns.list.days_and_times": "曜日と時間",
  ...
  "guestcampaigns.list.approver": "承認者",
  ...
  "guestcampaigns.list.custom_promotions.state_description_active": "現在 OpenTable で実施中のカスタムプロモーションを表示しています。",
  "guestcampaigns.list.custom_promotions.state_description_inactive": "過去に実施したカスタムプロモーションを表示しています。",
  ...
  "guestcampaigns.list.state_description_active": "これらのキャンペーンは OpenTable 上で適用されており、貴店への来店人数の増加に貢献しています。",
  "guestcampaigns.list.state_description_inactive": "これらは貴店で過去に展開されたキャンペーンです。現在は適用外となっており、貴店への来店人数の増加に貢献していません。",
  "guestcampaigns.list.state_description_paused": "停止中のキャンペーンは貴店への来店人数の増加に貢献していませんが、指定された時間に再開します。ご不明な点がおありの場合、またはこれらのキャンペーンを終了される場合は、OpenTable 担当者（{phone-number}）までお電話でご連絡ください。",
  ...
  "guestcampaigns.list.incentive.title": "タイトル",
  "guestcampaigns.list.incentive.description": "詳細情報",
  "guestcampaigns.list.incentive.terms": "利用規約",
  "guestcampaigns.list.incentive.includes": "Includes",
  "guestcampaigns.list.incentive.tax": "Tax",
  "guestcampaigns.list.incentive.service": "サービス",
  "guestcampaigns.list.incentive.approver": "承認者",
  ...
  "guestcampaigns.list.edit_blocked_days": "ブロック日を編集する",
  ...
  "guestcampaigns.list.button.got_it": "OK",
  ...
  "guestcampaigns.list.blockdays.button.days": "ブロック日",
  ...
  "guestcampaigns.list.blockdays.confirm.button.cancel": "キャンセル",
  ...
  "promos.flash.published": "プロモーションが公開されました。",
  "promos.flash.saved": "プロモーションが保存されました。",
  "promos.flash.removed": "プロモーションへの参加をやめました。",
  "promos.card.view": "プロモーションを表示する",
  "promos.card.edit": "編集する",
  "promos.card.join": "参加する",
  "promos.card.liveNow": "実施中",
  "promos.card.count": "{count}店舗",
  "promos.card.unavailable": "まもなく{year}年の参加受付開始",
  "promos.promo.name.1": "サンクスギビング",
  "promos.promo.placeholder.1": "スペシャルメニューの提供など、お客様がサンクスギビング・デーに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.4": "大晦日",
  "promos.promo.placeholder.4": "スペシャルメニューの提供など、お客様が大晦日に貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.5": "クリスマスイブ",
  "promos.promo.placeholder.5": "スペシャルメニューの提供など、お客様がクリスマスに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.6": "クリスマス",
  "promos.promo.placeholder.6": "スペシャルメニューの提供など、お客様がクリスマスに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.14": "屋外でのお食事",
  "promos.promo.description.14": "暖かい日はもちろん、寒い日でも暖かいランプを灯して。パティオ席、テラス席などの屋外空間でのお食事をオススメしましょう。",
  "promos.promo.placeholder.14": "テラス席でのお食事の魅力を説明してください。",
  "promos.promo.name.77": "母の日",
  "promos.promo.placeholder.77": "スペシャルメニューの提供など、お客様が母の日に貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.85": "父の日",
  "promos.promo.placeholder.85": "スペシャルメニューの提供など、お客様が父の日に貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.102": "バレンタインデー",
  "promos.promo.placeholder.102": "スペシャルメニューの提供など、お客様がバレンタインデーに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.212": "ブランチ",
  "promos.promo.description.212": "卵料理、パンケーキ、ダック・コンフィ・ハッシュなど、どんなお料理でもOK。お料理でお客様の週末の素敵な朝を演出しましょう。",
  "promos.promo.placeholder.212": "ブランチメニューのオススメポイントを紹介してください。",
  "promos.promo.name.228": "イースター",
  "promos.promo.placeholder.228": "スペシャルメニューの提供など、お客様がイースターに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.243": "観劇・イベント前後のお食事",
  "promos.promo.description.243": "お料理の提供時間の速さと文化施設へのアクセスの良さを生かして、観劇などのイベントのついでにお食事されるお客様にベストな選択肢を提供しましょう。",
  "promos.promo.placeholder.243": "貴店が観劇・イベント前後でのご利用にオススメな理由を説明してください。",
  "promos.promo.name.355": "シンコ・デ・マヨ",
  "promos.promo.placeholder.355": "スペシャルメニューの提供やイベントの開催など、お客様がシンコ・デ・マヨに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.promo.name.369": "充実したカクテルメニュー",
  "promos.promo.description.369": "職人技のカクテル、にぎやかなハッピーアワー、豊富な品ぞろえのワインリストで、お酒好きのお客様の関心を引き付けましょう。",
  "promos.promo.placeholder.369": "貴店がカクテル通に人気のヒミツを説明してください。",
  "promos.promo.name.370": "BYOB（酒類各自持参）",
  "promos.promo.description.370": "無料の持ち込みを許可する場合や、酒類販売権がない場合は、お客様に酒類の持ち込みができることをアピールしましょう。",
  "promos.promo.placeholder.370": "BYOB（酒類各自持参）のアピールポイントを入力してください。",
  "promos.promo.name.371": "ビジネスパーソンにオススメ",
  "promos.promo.description.371": "接待目的のエンターテインメントを提供するなど、接待や会食に一押しで、特にビジネス街に位置するお店に最適なオプションです。",
  "promos.promo.placeholder.371": "接待や会食など、ビジネスでの利用に適していることをアピールしましょう。",
  "promos.promo.name.630": "グルテンなし ",
  "promos.promo.description.630": "小麦粉を使わないパスタなど、グルテンフリーの食材を中心としたお食事を提供しているお店に最適なオプションです。",
  "promos.promo.placeholder.630": "貴店が提供するグルテンフリーメニューのアピールポイントを入力してください。",
  "promos.promo.name.631": "ベジタリアン対応",
  "promos.promo.description.631": "ベジタリアンやビーガン向けのお食事を提供しているお店に最適のオプションです。",
  "promos.promo.placeholder.631": "お肉を食べなくても、貴店のベジタリアンメニューでお客様が満足できることをアピールしましょう。",
  "promos.promo.name.728": "ハヌカー",
  "promos.promo.placeholder.728": "スペシャルメニューの提供など、お客様がハヌカーに貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.form.title.join": "{promoName}のプロモーション詳細の追加",
  "promos.form.title.edit": "{promoName}のプロモーション詳細の編集",
  "promos.form.description": "お客様へのメッセージ",
  "promos.form.placeholder": "お客様がプロモーションにて貴店を予約したくなるようなアピールポイントを入力してください。",
  "promos.form.enableCreditCard": "プロモーション提供時にクレジットカード情報を取得する設定にするには、GuestCenter の{restaurantSettingsLink}で Stripe を有効にしてください",
  "promos.form.restaurantSettings": "店舗設定",
  "promos.form.requireCreditCard": "予約時にクレジットカード情報の入力を必須とする",
  "promos.form.timeRangeStart": "開始日",
  "promos.form.timeRangeEnd": "終了日",
  "promos.form.timeRangeDivider": "～",
  "promos.form.betweenTimes": "次の時間帯",
  "promos.form.duringAllShifts": "すべてのシフト",
  "promos.form.timeRangeInvalidMessage": "開始時間は終了時間より前に設定してください。",
  "promos.form.inform": "お客様にキャンセル料についてご案内する",
  "promos.form.amount": "1人あたりの料金",
  "promos.form.days": "予約キャンセルのタイミング",
  "promos.form.dayBefore": "1日前",
  "promos.form.daysBefore": "{days}日前",
  "promos.form.dayOf": "日",
  "promos.form.publish": "設定更新",
  "promos.form.save": "保存",
  "promos.form.leave": "プロモーションへの参加をやめる",
  "promos.form.leave.confirm": "参加をやめますか？",
  "promos.form.error": "このプロモーションを公開できませんでした。再度お試しください。"
}