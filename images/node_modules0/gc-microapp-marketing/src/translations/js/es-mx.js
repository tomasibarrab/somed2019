;;window.Resources = {
  "app.title": "Marketing",
  "app.errorTitle": "Intentemos nuevamente",
  "app.errorMessage": "Vuelva a cargar la página. Si sigue el problemas, llame al 01 800 747 6118 y lo ayudaremos.",
  "app.unpublished": "Usted ha eliminado la publicación de cambios. ¿Desea salir sin publicar?",
  "days.sunday.long": "Domingo",
  "days.monday.long": "Lunes",
  "days.tuesday.long": "Martes",
  "days.wednesday.long": "Miércoles",
  "days.thursday.long": "Jueves",
  "days.friday.long": "Viernes",
  "days.saturday.long": "Sábado",
  "days.sunday.short": "Dom",
  "days.monday.short": "Lun",
  "days.tuesday.short": "Mar",
  "days.wednesday.short": "Mie",
  "days.thursday.short": "Jue",
  "days.friday.short": "Vie",
  "days.saturday.short": "Sáb",
  "times.morning.name": "Mañana",
  "times.midday.name": "Midday",
  "times.evening.name": "Noche",
  ...
  "flexiblepricing.educationpage.discoveryexplanation.content.criteria.reviews": "Reseñas",
  ...
  "nav.custompromotions": "Promociones Personalizadas",
  "nav.seasonal": "Promociones de temporada",
  "nav.featured": "Listas destacadas",
  "nav.flexiblepricing": "Flexible Pricing",
  "nav.insights": "Insights",
  "nav.privatedining": "Eventos Privados",
  "nav.guestcampaigns": "Campañas para los clientes",
  "nav.campaigns": "Campaigns",
  "nav.promotedresults": "Resultados promocionados",
  "nav.specials": "Ofertas especiales",
  "nav.gifts": "Gifts",
  ...
  "insights.common.promoted_results": "Resultados promocionados",
  "insights.common.promoted_results_with_targeting": "Resultados promocionados con segmentación",
  ...
  "seasonal.title": "Promociones de temporada",
  "seasonal.subtitle": "Vale la pena participar en las promociones de temporada. Es dos veces más probable que los comensales realicen reservaciones para las vacaciones, así que asegúrese de destacar los menúes especiales, los descuentos preestablecidos, los horarios, los eventos y las ofertas.",
  "seasonal.joined.subtitle": "Sus promociones",
  "seasonal.unjoined.subtitle": "Añadir promociones",
  "featured.title": "Listas destacadas",
  "featured.subtitle": "Motive a la gente a cenar en su restaurante promocionando sus menúes especiales, las características de su restaurante, las adaptaciones a diferentes dietas y las ofertas. Muestre lo que tiene para ofrecer, desde menúes para el brunch hasta platillos libres de gluten.",
  "featured.joined.subtitle": "Sus listas",
  "featured.unjoined.subtitle": "Añadir listas",
  "leadgen.form.description": "Díganos cómo localizarlo y nos comunicaremos dentro de las próximas 48 horas.",
  "leadgen.form.description_24": "Dinos cómo contactarte y nos comunicaremos en el transcurso de las 24 horas.",
  "leadgen.submitted.title": "¡Gracias!",
  "leadgen.submitted.simpleMessage": "Un miembro del equipo de restaurantes se comunicará con usted dentro de las próximas 48 horas.",
  "leadgen.submitted.simpleMessage_24": "A member of the restaurant team will reach out within 24 hours.",
  "leadgen.submitted.message": "Lo contactaremos en breve. Mientras tanto, puede obtener más información acerca de la función de Eventos privados {here}.",
  "leadgen.here": "aquí",
  "label.firstName": "Nombre",
  "label.lastName": "Apellido",
  "label.emailAddress": "Correo Electrónico",
  "label.phoneNumber": "Número de teléfono",
  "privatedining.title": "Eventos Privados",
  "gifts.title": "Gifts",
  "gifts.liveDate": "El nuevo OpenTable Gifts se lanza el 1 de octubre de 2018 y la versión actual de OpenTable Gifts quedará obsoleta.  Regístrese en el nuevo programa hoy mismo para asegurarse de que no haya ninguna alteración en las ventas de sus tarjetas de regalo.",
  "gifts.landing.one.header": "Atraiga más clientes",
  "gifts.landing.one": "Venda sus tarjetas de regalo a 5 millones de clientes que quieren regalarles a otras personas sus experiencias gastronómicas favoritas.",
  "gifts.landing.two.header": "Aumente sus ingresos",
  "gifts.landing.two": "Atraiga a esos clientes por $25/mes. Lo único que necesita es una página en línea donde pueda vender tarjetas de regalo.",
  "gifts.landing.cta": "Inscríbase ahora",
  "gifts.main.gift_card_website.title": "Sitio web de tarjetas de regalo",
  "gifts.main.gift_card_website.description": "Si tiene sitios web distintos para compras de tarjetas virtuales y físicas, ingrese un sitio web donde los clientes puedan seleccionar cualquiera de las opciones.",
  "gifts.main.header.cancel": "Cancelar",
  "gifts.main.header.publish": "Publicar",
  "gifts.main.header.save": "Guardar",
  "gifts.main.toast.success": "Success! Your Gift Card website link has been updated.",
  "gifts.terms.client_has_read": "El cliente leyó, comprendió y aceptó los términos del {gifts-client-agreement-link}. Declaro y garantizo que soy mayor de edad para formalizar un contrato vinculante y tengo autoridad legal plena para vincular al cliente a este contrato.",
  "gifts.terms.sign_up": "Crear una cuenta",
  "gifts.terms.must_be_authorized": "Debe estar autorizado a firmar en nombre de su restaurante",
  "gifts.terms.gifts_client_agreement": "Acuerdo del cliente en relación a Gifts",
  "gifts.terms.description": "Para registrarse en Gifts, debe estar de acuerdo con el {gifts-client-agreement-link} y aceptar pagar $25 por mes en representación de su restaurante.",
  "gifts.finished.title": "You’re done!",
  "gifts.finished.description.1": "Recuerde, Gifts estará disponible a partir del 1.º de octubre de 2018.",
  ...
  "gifts.finished.description.2.our_faq": "nuestras preguntas frecuentes",
  "gifts.finished.ok_got_it": "Ok. Entendido",
  "privatedining.leadgen.heading": "Publique su comedor privado",
  "privatedining.leadgen.body": "Capture más clientes potenciales para eventos grupales y fiestas durante todo el año. Publique su espacio en nuestro directorio de eventos privados para promocionarlo en nuestra red, en correos electrónicos a comensales y en búsquedas de Google, para obtener la mejor publicidad.",
  "privatedining.leadgen.button.label": "Estoy interesado",
  "privatedining.enabled.heading": "Se ha registrado en Private Dining",
  "privatedining.enabled.body": "Para realizar cambios en su perfil, contáctese con el servicio de soporte escribiendo a",
  "privatedining.enabled.body.email": "mexicosupport@opentable.com",
  ...
  "privatedining.enabled.body.email.thankyou": "¡Gracias!",
  "privatedining.enabled.body.phone": "o llámenos al 01 800 747 6118.",
  "privatedining.form.publish": "Publicar",
  "privatedining.form.publish.success": "¡Gracias! Hemos recibido su perfil. Le informaremos cuando esté activo dentro de las próximas 28 horas.",
  "privatedining.form.publish.error.modal.title": "Eventos Privados",
  "privatedining.form.publish.error.modal.message": "Su perfil de Eventos privados no se ha podido publicar. Inténtelo de nuevo",
  "privatedining.form.publish.error.modal.ok": "OK",
  "privatedining.enabled.v2.section.info.title": "Detalles de los Eventos privados",
  "privatedining.enabled.v2.section.info.listing.description": "Esto aparecerá en la página de perfil de su restaurante y en su perfil de eventos privados en opentable.com.",
  "privatedining.enabled.v2.section.contact.title": "Detalles del coordinador de eventos",
  "privatedining.enabled.v2.section.contact.description": "Informe al público cómo puede contactarlo para obtener más información sobre los eventos privados.",
  "privatedining.enabled.v2.section.rooms.title": "Opciones de eventos privados",
  "privatedining.enabled.v2.section.rooms.description": "Agregue hasta 5 áreas para eventos privados que aparecerán en su perfil de Eventos privados.",
  "privatedining.enabled.v2.fields.name": "Nombre",
  "privatedining.enabled.v2.fields.phone": "Número de teléfono",
  "privatedining.enabled.v2.fields.phone.ext": "Extensión",
  "privatedining.enabled.v2.fields.email": "Correo Electrónico",
  "privatedining.enabled.v2.fields.listing.description": "Descripción breve",
  "privatedining.enabled.v2.fields.profile.description": "Descripción detallada",
  "privatedining.enabled.v2.fields.url": "URL ejemplo del menú",
  "privatedining.enabled.v2.fields.capacity": "Capacidad máxima para eventos",
  "privatedining.enabled.v2.fields.photo": "Foto de eventos privados",
  "privatedining.enabled.v2.fields.room.active": "Mostrar la habitación en el perfil",
  "privatedining.enabled.v2.fields.room.name": "Nombre del cuarto",
  "privatedining.enabled.v2.fields.room.description": "Descripción",
  "privatedining.enabled.v2.fields.room.seated": "Capacidad sentados",
  "privatedining.enabled.v2.fields.room.standing": "Capacidad en pie",
  "privatedining.enabled.v2.fields.room.photo": "Foto de eventos privados",
  "privatedining.enabled.v2.fields.room.add": "+ Agregar otra habitación",
  "privatedining.enabled.v2.photo.modal.add.title": "Agregar foto",
  "privatedining.enabled.v2.photo.modal.crop.title": "Recortar foto",
  "privatedining.enabled.v2.photo.modal.instructions": "Arrastre y suelte su foto o",
  "privatedining.enabled.v2.photo.modal.select": "Seleccione una foto",
  "privatedining.enabled.v2.photo.modal.standards": "Usar fotos JPEG o PNG, 512 x 512 píxeles como mínimo, 10MB como máximo",
  "privatedining.enabled.v2.photo.modal.errors.toosmall": "Las dimensiones de la foto son demasiado pequeñas. El tamaño mínimo es de 512 x 512 píxeles.",
  "privatedining.enabled.v2.photo.modal.errors.wrongtype": "No reconocemos ese formato de archivo. Cargue un archivo JPEG o PNG.",
  "privatedining.enabled.v2.photo.add": "+ Agregar foto",
  "privatedining.enabled.v2.photo.replace": "Reemplazar foto",
  "privatedining.enabled.v2.photo.save": "Guardar",
  "guestcampaigns.title": "Resultados promocionados",
  "guestcampaigns.support.phone": "(800) 673-6822",
  "guestcampaigns.heading": "Atrae clientes con resultados promocionados",
  "guestcampaigns.subheading": "Destácate en resultados de búsqueda para aumentar tu exposición y que te vean los clientes indecisos.",
  "guestcampaigns.beincontrol.title": "Be in control",
  "guestcampaigns.targetdiners.title": "Capta los clientes que tú quieras",
  "guestcampaigns.promotedinventory.title": "Genera más reservaciones",
  "guestcampaigns.beincontrol.description": "Select when you want extra visibility. Pause or launch at will.",
  "guestcampaigns.targetdiners.description": "Elige entre clientes de último momento y clientes que van por primera vez. ¡O ambos!",
  "guestcampaigns.promotedinventory.description": "Coloque a su restaurante en los primeros lugares de las listas de restaurantes.",
  ...
  "guestcampaigns.list.campaigndates": "Días y horarios",
  "guestcampaigns.list.campaigndetails": "Campaign Details",
  "guestcampaigns.list.custom_promotion": "Custom Promotion",
  "guestcampaigns.list.custom_promotions": "Promociones Personalizadas",
  "guestcampaigns.list.short_term_custom_promotions": "Promociones personalizadas a corto plazo",
  "guestcampaigns.list.start_date": "Start Date",
  "guestcampaigns.list.end_date": "End Date",
  "guestcampaigns.list.blockeddates": "Fechas bloqueadas",
  "guestcampaigns.list.promoted_results": "Resultados promocionados",
  ...
  "guestcampaigns.list.specials": "Ofertas especiales",
  ...
  "guestcampaigns.list.date.label.promoted_results": "Resultado promocionado",
  ...
  "guestcampaigns.specials.form.header.cancelbutton": "Cancelar",
  "guestcampaigns.specials.form.header.publishbutton": "Publicar",
  "guestcampaigns.specials.form.header.title": "Crear nueva oferta especial",
  ...
  "guestcampaigns.specials.form.type.title": "Tipo",
  "guestcampaigns.specials.form.type.description": "Elija el tipo de oferta especial que desea crear.",
  "guestcampaigns.specials.form.type.happy_hour": "Happy Hour",
  "guestcampaigns.specials.form.type.complimentary_drink": "Bebida de cortesía",
  "guestcampaigns.specials.form.type.complimentary_appetizer": "Aperitivo de cortesía",
  "guestcampaigns.specials.form.alcohol_warning": "Special offers on alcoholic beverages may be restricted by state law.",
  "guestcampaigns.specials.form.title.title": "Título",
  "guestcampaigns.specials.form.title.description": "Modifique este título para hacerlo único. Los comensales lo verán en OpenTable.",
  ...
  "guestcampaigns.specials.form.title.tips.1": "Esto atrae a las personas más que la descripción.",
  "guestcampaigns.specials.form.title.tips.2": "Dele personalidad al título.",
  "guestcampaigns.specials.form.title.tips.3": "Use 5 palabras como máximo (no es necesario incluir el nombre del restaurante).",
  "guestcampaigns.specials.form.description.title": "Descripción",
  "guestcampaigns.specials.form.description.description": "Escriba una descripción única. Los comensales la verán en el perfil de su restaurante de OpenTable.",
  ...
  "guestcampaigns.specials.form.description.tips.1": "Describa lo que está ofreciendo.",
  "guestcampaigns.specials.form.description.tips.2": "Trate de que no sean más de dos oraciones.",
  "guestcampaigns.specials.form.description.tips.3": "Nota: si el especial involucra un precio específico, incluya impuestos y cargos por servicio.",
  "guestcampaigns.specials.form.startdate.title": "Fecha de comienzo de la reservación",
  "guestcampaigns.specials.form.startdate.description": "Hemos preseleccionado una fecha para dentro de una semana. Esto les dará a los comensales suficiente tiempo para reservar su especial.",
  ...
  "guestcampaigns.specials.form.daysandtimes.title": "Días y horarios",
  "guestcampaigns.specials.form.daysandtimes.description": "Especifique los días y horarios en los que desea llevar a cabo su oferta especial.",
  "guestcampaigns.specials.form.daysandtimes.tips.1": "Recomendamos seleccionar horarios en los que ya ofrece un Happy Hour o una oferta especial.",
  "guestcampaigns.specials.form.daysandtimes.tips.2.happy_hour": "Do you run happy hour at multiple times?",
  "guestcampaigns.specials.form.daysandtimes.tips.2.generic": "¿Desea crear la oferta especial para muchas fechas?",
  "guestcampaigns.specials.form.daysandtimes.tips.2.add": "Agregar otra fecha y horario",
  "guestcampaigns.specials.form.blockeddays.title": "Días bloqueados",
  "guestcampaigns.specials.form.blockeddays.description": "Especifique los días en los que no desea ofrecer una oferta especial. De manera predeterminada, hemos bloqueado los días que generalmente atraen a más huéspedes.",
  "guestcampaigns.specials.form.blockeddays.add": "Agregar días bloqueados",
  "guestcampaigns.specials.form.nextstep.title": "Siguiente paso",
  "guestcampaigns.specials.form.nextstep.description.1": "Publique su oferta especial",
  "guestcampaigns.specials.form.nextstep.description.2": "sin cargo adicional.",
  "guestcampaigns.specials.landingpage.standout.title": "Consiga más comensales cuando los desee.",
  "guestcampaigns.specials.landingpage.standout.subtitle": "Las ofertas especiales muestran una promoción que usted elija. Son una excelente forma de:",
  "guestcampaigns.specials.landingpage.bullet.1.title": "Ampliar su alcance.",
  "guestcampaigns.specials.landingpage.bullet.1.description": "Las ofertas especiales generan un aumento promedio de cubiertos del 5%.",
  "guestcampaigns.specials.landingpage.bullet.2.title": "Maximizar el retorno.",
  "guestcampaigns.specials.landingpage.bullet.2.description": "Las mesas vacías son una pérdida. Al ofrecer un detalle adicional puede atraer comensales.",
  "guestcampaigns.specials.landingpage.bullet.3.title": "Comercializar turnos lentos.",
  "guestcampaigns.specials.landingpage.bullet.3.description": "Atraiga más comensales durante los turnos de transición, noches lentas o en cualquier otro momento.",
  "guestcampaigns.specials.landingpage.free": "Es gratis crear una oferta especial (está incluido en su cuota de comensal).",
  "guestcampaigns.specials.landingpage.create": "Cree un especial",
  "guestcampaigns.specials.completed.heading": "Ya está listo. Su oferta especial se publicará durante los próximos 30 minutos.",
  "guestcampaigns.specials.completed.description.confirmationemail": "Enviaremos un correo electrónico de confirmación.",
  "guestcampaigns.specials.completed.description.questions": "Mientras tanto, si tiene alguna pregunta sobre las ofertas especiales, llame al servicio de atención al cliente al 01-800-7476118",
  "guestcampaigns.terms.terms_and_conditions": "Términos y condiciones",
  "guestcampaigns.terms.specials.description": "Para publicar esta oferta especial, tiene que aceptar los términos y condiciones escribiendo su nombre, el nombre legal de su restaurante y afirmando que ha leído y está de acuerdo con los términos.",
  ...
  "guestcampaigns.terms.your_email": "Su correo electrónico",
  "guestcampaigns.terms.your_name": "Su nombre",
  "guestcampaigns.terms.authorized": "You must be authorized to sign for your restaurant",
  "guestcampaigns.terms.restaurant_legal_name": "Nombre legal de su restaurante",
  "guestcampaigns.terms.client_has_read": "El cliente ha leído, entendido y acepta estar obligado por los términos de las {opentable-client-agreement-link}. Declaro y garantizo que soy mayor de edad para formalizar un contrato vinculante y tengo autoridad legal plena para vincular al cliente a este contrato.",
  ...
  "guestcampaigns.terms.agree_and_publish": "Aceptar y publicar",
  ...
  "guestcampaigns.list.short_term_promoted_results": "Resultados promocionados a corto plazo",
  ...
  "guestcampaigns.list.resumesin": "Se reinicia el {in-time-amount}",
  "guestcampaigns.list.resumesat": "Se reanuda el",
  ...
  "guestcampaigns.list.noenddate": "No hay fecha de finalización",
  "guestcampaigns.list.bookingwindow": "Plazo para reservaciones",
  "guestcampaigns.list.seatingwindow": "Plazo para ocupación",
  "guestcampaigns.list.search_exposure": "Search Exposure",
  "guestcampaigns.list.cover_price": "Cover Price",
  "guestcampaigns.list.price": "Precio",
  "guestcampaigns.list.monthly_budget": "Monthly Budget",
  "guestcampaigns.list.days_and_times": "Días y horarios",
  ...
  "guestcampaigns.list.approver": "Autorizador",
  ...
  "guestcampaigns.list.custom_promotions.state_description_active": "Estas son promociones personalizadas que están activas actualmente en OpenTable.",
  "guestcampaigns.list.custom_promotions.state_description_inactive": "Estas son las promociones personalizadas que han estado activas anteriormente",
  ...
  "guestcampaigns.list.promoted_results.state_description_paused": "Las campañas en pausa no atraen clientes a tu restaurante pero se reiniciarán en el momento especificado. Llama a tu representante de OpenTable al {phone-number} en caso de tener preguntas o si deseas cancelar estas campañas.",
  ...
  "guestcampaigns.list.state_description_active": "Estas campañas están activas en OpenTable y atraerán a más clientes a su restaurante.",
  "guestcampaigns.list.state_description_inactive": "Estas son campañas que llevó a cabo en el pasado. Ya no están activas y no atraen clientes a su restaurante.",
  "guestcampaigns.list.state_description_paused": "Las campañas en pausa no atraen clientes a su restaurante pero se reiniciarán en el momento especificado. Llame a su representante de OpenTable al {phone-number} en caso de tener preguntas o si desea cancelar estas campañas.",
  ...
  "guestcampaigns.list.incentive.title": "Puesto",
  "guestcampaigns.list.incentive.description": "Descripción",
  "guestcampaigns.list.incentive.terms": "Términos",
  "guestcampaigns.list.incentive.includes": "Includes",
  "guestcampaigns.list.incentive.tax": "Tax",
  "guestcampaigns.list.incentive.service": "Servicio",
  "guestcampaigns.list.incentive.approver": "Autorizador",
  ...
  "guestcampaigns.list.edit_blocked_days": "Editar los días bloqueados",
  ...
  "guestcampaigns.list.button.got_it": "Ok. Entendido.",
  ...
  "guestcampaigns.list.blockdays.button.days": "Días bloqueados",
  ...
  "guestcampaigns.list.blockdays.confirm.button.cancel": "Cancelar",
  ...
  "promos.flash.published": "Su promoción se ha publicado.",
  "promos.flash.saved": "Su promoción se ha guardado.",
  "promos.flash.removed": "Su promoción se ha eliminado.",
  "promos.card.view": "Ver promoción",
  "promos.card.edit": "Editar",
  "promos.card.join": "Unirse",
  "promos.card.liveNow": "En vivo ahora",
  "promos.card.count": "{count} restaurantes",
  "promos.card.unavailable": "Los inicios de sesión de {year} se encontrarán disponibles próximamente",
  "promos.promo.name.1": "Día de Acción de Gracias",
  "promos.promo.placeholder.1": "¿Ofrece un menú especial para el Día de Acción de Gracias? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.4": "Víspera de Año Nuevo",
  "promos.promo.placeholder.4": "¿Ofrece un menú especial para la Víspera de Año Nuevo? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.5": "Nochebuena",
  "promos.promo.placeholder.5": "¿Ofrece un menú especial para Navidad? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.6": "Día de Navidad",
  "promos.promo.placeholder.6": "¿Ofrece un menú especial para Navidad? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.14": "Al aire libre",
  "promos.promo.description.14": "Cuando los días son cálidos o no tanto pero cuenta con lámparas de calefacción, el patio, la terraza u otro espacio al aire libre de su restaurante es el destino ideal para comer afuera.",
  "promos.promo.placeholder.14": "Coméntenos por qué sus opciones de cenas al aire libre atraen a los comensales.",
  "promos.promo.name.77": "Día de la Madre",
  "promos.promo.placeholder.77": "¿Ofrece un menú especial para el Día de la Madre? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.85": "Día del Padre",
  "promos.promo.placeholder.85": "¿Ofrece un menú especial para el Día del Padre? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.102": "Día de San Valentín",
  "promos.promo.placeholder.102": "¿Ofrece un menú especial para el Día de San Valentín? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.212": "Brunch",
  "promos.promo.description.212": "Huevos, crepas, pato confitado, o cualquier otro plato, los invitados adorarán las mañanas de los fines de semana en su restaurante.",
  "promos.promo.placeholder.212": "Coméntenos por qué su menú de brunch es el mejor.",
  "promos.promo.name.228": "Pascua",
  "promos.promo.placeholder.228": "¿Ofrece un menú especial para Pascua? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.243": "Gastronomía y teatro",
  "promos.promo.description.243": "Desde un servicio rápido hasta la cercanía de los centros culturales, su restaurante es el lugar ideal para las personas que van al teatro y otros comensales para quienes la cena no es el evento principal.",
  "promos.promo.placeholder.243": "Coméntenos por qué su restaurante es una opción maravillosa para las personas que van al teatro.",
  "promos.promo.name.355": "Cinco de Mayo",
  "promos.promo.placeholder.355": "¿Su restaurante organiza algo especial para el Cinco de Mayo? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.promo.name.369": "Cultura de cócteles",
  "promos.promo.description.369": "Desde cócteles elaborados hasta happy hours animados y listas de vinos costosos, su restaurante ofrece un nivel alto para aquellos que aman las bebidas fabulosas.",
  "promos.promo.placeholder.369": "Coméntenos por qué las personas que adoran los cócteles elaborados indudablemente irán a su bar.",
  "promos.promo.name.370": "Traiga su propia bebida alcohólica",
  "promos.promo.description.370": "¿Ofrece descorche libre? ¿No cuenta con una licencia para vender alcohol? Promocione la novedad de que los clientes pueden traer sus propias botellas para disfrutar en su restaurante.",
  "promos.promo.placeholder.370": "Coméntenos por qué el hecho de que los clientes puedan traer su propia bebida alcohólica realzará cualquier comida.",
  "promos.promo.name.371": "Comidas abundantes",
  "promos.promo.description.371": "Los almuerzos y cenas empresariales y atender a grupos de trabajo son su especialidad, particularmente si su restaurante está ubicado en una zona comercial.",
  "promos.promo.placeholder.371": "Coméntenos por qué atrae comensales empresariales.",
  "promos.promo.name.630": "Libre de gluten ",
  "promos.promo.description.630": "¿Ofrece pasta libre de gluten o granos alternativos? Informe a los clientes si su menú incluye una variedad de platillos que están específicamente adaptados a una gastronomía sin trigo ni gluten.",
  "promos.promo.placeholder.630": "Coméntenos por qué su menú libre de gluten es el mejor de todos.",
  "promos.promo.name.631": "Platillos veganos y vegetarianos",
  "promos.promo.description.631": "¿Su menú incluye una variedad de platillos que satisfarían a un hambriento vegetariano o vegano?",
  "promos.promo.placeholder.631": "Coméntenos por qué su menú con vegetales satisfará a los comensales que no comen carne.",
  "promos.promo.name.728": "Hanukkah",
  "promos.promo.placeholder.728": "¿Ofrece un menú especial para Hanukkah? Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para este día festivo.",
  "promos.form.title.join": "Añadir detalles de la promoción para {promoName}",
  "promos.form.title.edit": "Editar detalles de la promoción para {promoName}",
  "promos.form.description": "Lo que los comensales deberían saber",
  "promos.form.placeholder": "Coméntenos por qué su restaurante es el lugar ideal para realizar una reservación para esta promoción.",
  "promos.form.enableCreditCard": "Para configurar las acreditaciones con tarjeta de crédito para las promociones, active Stripe desde GuestCenter en {restaurantSettingsLink}",
  "promos.form.restaurantSettings": "Configuración del restaurante",
  "promos.form.requireCreditCard": "Solicite una tarjeta de crédito para garantizar las reservaciones",
  "promos.form.timeRangeStart": "Inicio",
  "promos.form.timeRangeEnd": "Fin",
  "promos.form.timeRangeDivider": "a",
  "promos.form.betweenTimes": "entre turnos",
  "promos.form.duringAllShifts": "durante todos los turnos",
  "promos.form.timeRangeInvalidMessage": "Seleccione un tiempo de finalización que sea posterior a la fecha de inicio.",
  "promos.form.inform": "Informe a los clientes las tarifas de cancelación",
  "promos.form.amount": "Cargo por persona de",
  "promos.form.days": "Si las reservaciones se cancelan",
  "promos.form.dayBefore": "1 días antes",
  "promos.form.daysBefore": "{days} días antes",
  "promos.form.dayOf": "Día de",
  "promos.form.publish": "Publicar",
  "promos.form.save": "Guardar",
  "promos.form.leave": "Eliminar el restaurante de la promoción",
  "promos.form.leave.confirm": "¿Confirma que desea eliminar el restaurante?",
  "promos.form.error": "Su promoción no se ha podido publicar. Inténtelo de nuevo"
}